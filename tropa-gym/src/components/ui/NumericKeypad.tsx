    ...
    <div className="grid w-full max-w-xs grid-cols-3 gap-2">
      {TECLAS.map((tecla) => (
        <button
          ...
          className="flex h-16 items-center justify-center rounded-lg border border-outline-variant bg-surface-container-low font-oswald text-2xl font-bold text-on-surface transition-colors hover:bg-surface-container-high active:bg-surface-container-highest"
        >
          {tecla === 'borrar' ? (
